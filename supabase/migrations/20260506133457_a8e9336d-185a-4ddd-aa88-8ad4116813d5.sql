REVOKE EXECUTE ON FUNCTION public.is_current_vendor_user_for_vendor(uuid) FROM anon;
REVOKE EXECUTE ON FUNCTION public.is_current_vendor_invited_to_rfp(uuid) FROM anon;

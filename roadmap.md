...
- [ ] Role-based "My Briefing" page after sign-in — structure approved by user; chat history saved in database (confirmed)
...
- [x] Admin on/off switch screen for AI (Admin → Branding)

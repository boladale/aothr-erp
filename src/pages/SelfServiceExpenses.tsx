  ...
  return (
    <AppLayout>
      <div className="page-container space-y-6">
        <PageHeader title="My Expense Claims" description="Submit and track expense reimbursements" actions={<><Button onClick={() => setOpen(true)}><Plus className="h-4 w-4 mr-2" /> New Claim</Button></>} />

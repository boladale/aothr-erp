...
export type AppRole = 'admin' | 'procurement_manager' | 'procurement_officer' | 'warehouse_manager' | 'warehouse_officer' | 'accounts_payable' | 'ap_clerk' | 'requisitioner' | 'viewer' | 'hr_manager' | 'hr_officer' | 'payroll_manager' | 'employee' | 'vendor_user' | 'finance_manager' | 'executive';

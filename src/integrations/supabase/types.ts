...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      employee_salary: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "employee_salary_pay_grade_id_fkey"
    ...
    Functions: {
      ...
      ai_cash_outlook: { Args: never; Returns: Json }
      ...
      ai_procurement_spend: { Args: never; Returns: Json }
      ...
      ai_revenue_breakdown: { Args: never; Returns: Json }
